...
class AbstractCustomProductVariation
{
    ...
    public function __construct($variation, $parent = null)
    {
        ...
        }elseif ($parent instanceof AbstractCustomProduct){
            $this->parent = $parent;
    ...
    /**
     * @return AbstractCustomProduct
     * @throws \RuntimeException
     */
    public function getParent(): AbstractCustomProduct
    {
     ...
     * @return AbstractCustomProduct
     */
    protected function createVariableProductInstance(int $parentId)
    {
        return new AbstractCustomProduct($parentId);
    }
}