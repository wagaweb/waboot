...
class AbstractCustomProduct
{
    ...
    private $isVariable;
    /**
     * @var AbstractCustomProductVariation[]
     */
    private $variations;
    ...
    /**
     * @return array|AbstractCustomProductVariation[]
     */
     ...
     * @return AbstractCustomProductVariation
     */
    protected function createVariationInstance(\WC_Product_Variation $variation)
    {
        return new AbstractCustomProductVariation($variation->get_id(),$this);
    }
}