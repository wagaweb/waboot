...
function admin_styles(){
	$file = get_stylesheet_directory()."/assets/dist/css/waboot-admin.min.css";
	if(is_readable($file)){
		$version = filemtime($file);
		wp_register_style('waboot-admin-style', get_stylesheet_directory_uri()."/assets/dist/css/waboot-admin.min.css", [], $version, 'all' );
...
function editor_style() {
	add_editor_style(get_stylesheet_directory_uri()."/assets/dist/css/waboot-admin-tinymce.min.css");
}
