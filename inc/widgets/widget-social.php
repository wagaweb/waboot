...
class Social extends \WP_Widget {
	...
	function form($instance){
		...
		<p>
			...
			<input placeholder="<?php _e( 'New title', 'waboot' ); ?>" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
		</p>
		<?php
	}
