...
function waboot_bootstrap_js_loader() {
	...
	wp_enqueue_script( 'bootstrap.js', alienship_locate_template_uri( 'assets/js/bootstrap.min.js' ), array( 'jquery' ), '3.0.2', true );
	...
	wp_enqueue_script( 'dropdown-toggle.js', alienship_locate_template_uri( 'sources/js/dropdown-toggle.js' ), array('jquery'),'1.0.0', true);
