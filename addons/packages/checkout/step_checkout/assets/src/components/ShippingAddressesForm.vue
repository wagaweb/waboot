...
import type {fetchedCountry, userShippingData, userShippingDataWP} from "../../env";
...
const emit = defineEmits<{
    (e: 'AddressDataSubmitted', formData: userShippingData): void
}>();
...
const onSubmit = handleSubmit(values => {
    emit('AddressDataSubmitted', formData.value as userShippingData);
});
...
<template>
    <section class="woocommerce-checkout-steps__content" id="checkout-step-2">
        ...
        <div class="shipping-addresses" v-if="!loadingAddresses">
            ...
            <div class="shipping-addresses__item shipping-addresses__item--btn">
        ...
        <div class="checkout woocommerce-checkout" v-show="addingNewAddress">
            <div class="woocommerce-checkout-steps__row">
                ...
                <button @click="onRemovingNewShippingAddress" class="btn btn--underline"><i class="icon icon-close"></i> Chiudi
                </button>
            </div>
