        ...
        <form action="" class="checkout woocommerce-checkout">
            <div class="woocommerce-billing-fields__field-wrapper">
                ...
                <div class="form-row form-row-wide">
                    ...
                    <input type="text" placeholder="Via e numero civico" id="address">
                </div>
                <div class="form-row form-row-third">
                    <label for="zip-code">Cap <span>*</span></label>
                    <input type="text" placeholder="Placeholder" id="zip-code">
                </div>
                <div class="form-row form-row-third">
                ...
                <div class="form-row form-row-wide">
                    ...
                    <textarea id="notes" placeholder="Nome sul citofono quando diverso dall'intestatario, C/O, interno, richieste particolari"></textarea>
                </div>
            </div>
