        ...
        function render_field($field)
        {
            ...
            <div <?php acf_esc_attr_e($atts); ?>>
                ...
                <div class="title acf-soh">
                    ...
                    <div class="has-value">
                        <a href="#" data-name="clear-location" class="acf-icon light acf-soh-target"
                           title="<?php _e("Clear location", 'acf'); ?>">
                    ...
                    <div class="no-value">
                        <a href="#" data-name="find-location" class="acf-icon light acf-soh-target"
                           title="<?php _e("Find current location", 'acf'); ?>">
