        ...
        */
        ...
        function render_attachment($id = 0, $field)
        {
            ...
            <div class="acf-gallery-side-info acf-cf">
                <img src="<?php echo $attachment['sizes']['thumbnail']['url']; ?>"
                ...
                <p class="actions"><a href="#" class="edit-attachment" data-id="<?php echo $id; ?>">Edit</a> <a href="#"
                                                                                                                class="remove-attachment"
                                                                                                                data-id="<?php echo $id; ?>">Remove</a>
                </p>
            </div>
        ...
        function render_field($field)
        {
            ...
            <div <?php acf_esc_attr_e($atts); ?>>
                ...
                <div class="acf-hidden">
                    <input
                        type="hidden" <?php acf_esc_attr_e(array('name' => $field['name'], 'value' => '', 'data-name' => 'ids')); ?> />
                </div>
                        ...
                        <?php if (!empty($field['value'])):
                            ...
                            foreach ($field['value'] as $id):
                                ...
                                <div class="acf-gallery-attachment acf-soh" data-id="<?php echo $id; ?>">
                                    ...
                                    <div class="actions acf-soh-target">
                                        <a class="acf-icon dark remove-attachment" data-id="<?php echo $id; ?>"
                                           href="#">
                                            <i class="acf-sprite-delete"></i>
                                        </a>
                                    </div>
