     ...
     */
        ...
        function render_field($field)
        {
            ...
            <div id="wp-<?php echo $id; ?>-wrap"
                 class="acf-wysiwyg-wrap wp-core-ui wp-editor-wrap <?php echo $switch_class; ?>"
                ...
                <div id="wp-<?php echo $id; ?>-editor-tools" class="wp-editor-tools hide-if-no-js">
                    ...
                    <?php if (user_can_richedit() && $show_tabs): ?>
                        <div class="wp-editor-tabs">
                            <a id="<?php echo $id; ?>-html" class="wp-switch-editor switch-html"
                               onclick="switchEditors.switchto(this);"><?php echo _x('Text', 'Name for the Text editor tab (formerly HTML)'); ?></a>
                            <a id="<?php echo $id; ?>-tmce" class="wp-switch-editor switch-tmce"
                               onclick="switchEditors.switchto(this);"><?php echo __('Visual'); ?></a>
                        </div>
                    <?php endif; ?>
                </div>
