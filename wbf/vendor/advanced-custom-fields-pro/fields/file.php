        ...
        function render_field($field)
        {
            ...
            <div <?php acf_esc_attr_e(array('class' => $o['class'], 'data-library' => $field['library'])); ?>>
                <div class="acf-hidden">
                    <input
                        type="hidden" <?php acf_esc_attr_e(array('name' => $field['name'], 'value' => $field['value'], 'data-name' => 'id')); ?> />
                </div>
                <div class="show-if-value file-wrap acf-soh">
                    ...
                    <div class="file-info">
                        ...
                        <ul class="acf-hl acf-soh-target">
                            <li><a class="acf-icon dark" data-name="edit" href="#"><i class="acf-sprite-edit"></i></a>
                            </li>
                            <li><a class="acf-icon dark" data-name="remove" href="#"><i
                ...
                <div class="hide-if-value">
                    <p><?php _e('No File selected', 'acf'); ?> <a data-name="add" class="acf-button"
