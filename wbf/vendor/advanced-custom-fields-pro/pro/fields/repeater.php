                ...
                <table <?php acf_esc_attr_e(array('class' => "acf-table acf-input-table {$field['layout']}-layout")); ?>>
                    ...
                    <?php foreach ($field['value'] as $i => $row): ?>
                        ...
                        <?php endif; ?>
                            ...
                            <?php if ($show_remove): ?>
                                <td class="remove">
                                    <a class="acf-icon small acf-repeater-add-row" href="#" data-before="1"
                                       title="<?php _e('Add row', 'acf'); ?>"><i class="acf-sprite-add"></i></a>
                                    <a class="acf-icon small acf-repeater-remove-row" href="#"
                                       title="<?php _e('Remove row', 'acf'); ?>"><i class="acf-sprite-remove"></i></a>
                                </td>
                            <?php endif; ?>
